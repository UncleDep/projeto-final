...
CREATE VIEW ATIVIDADES_DA_DISCIPLINA AS SELECT DISTINCT TITULO, DESCRICAO, ATIVIDADE.ID, DISCIPLINA, AUTOR FROM ATIVIDADE, ATIVIDADE_DISCIPLINA WHERE ATIVIDADE.ID = ATIVIDADE_DISCIPLINA.ATIVIDADE;

CREATE VIEW ATIVIDADES_DA_TURMA AS SELECT DISTINCT TITULO, DESCRICAO, ATIVIDADE.ID, TURMA, AUTOR FROM ATIVIDADE, ATIVIDADE_TURMA WHERE ATIVIDADE.ID = ATIVIDADE_TURMA.ATIVIDADE;
